...
//public class BNeuroNet : MonoBehaviour
//{
...
//            for (byte j = 0; j < 9; j++)
//            {
//                weights[k][j] = nbs.bestweights[k][j];
//            }
//        }
//        for (byte k = 4; k < 6; k++)
//        {
...
//                    if (distance < View)
//                    {
//                        Food += new Vector2(View * 2 - vec.x, View * 2 - vec.y);
//                    }
//                }
//            }
//        }
...
//        if (Food == new Vector2(0f, 0f)) Food = new Vector2(Random.Range(-1f, 1f), Random.Range(-1f, 1f));
...
//        energy -= startEnergy;
//        child.GetComponent<BNeuroNet>().energy = startEnergy;
//        child.GetComponent<BNeuroNet>().transform.localScale = new Vector3(tr.localScale.x * Random.Range(0.95f, 1.05f), tr.localScale.y * Random.Range(0.95f, 1.05f));

//        child.GetComponent<BNeuroNet>().pochEnergy = pochEnergy * Random.Range(0.99f, 1.01f);

//        child.GetComponent<BNeuroNet>().speed = speed * Random.Range(0.95f, 1.05f) * Mathf.Sqrt(child.GetComponent<BNeuroNet>().transform.localScale.y / child.GetComponent<BNeuroNet>().transform.localScale.x);
//        child.GetComponent<BNeuroNet>().View = View * Random.Range(0.98f, 1.02f) * (1 + child.GetComponent<BNeuroNet>().transform.localScale.x * child.GetComponent<BNeuroNet>().transform.localScale.y / 16);

//        child.GetComponent<BNeuroNet>().weights = weights;
//        child.GetComponent<BNeuroNet>().input = input;
//        child.GetComponent<BNeuroNet>().transform.localScale = new Vector3(0.4f, 0.4f, 0);
